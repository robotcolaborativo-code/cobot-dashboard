        ...
        <div class="dashboard-grid">
            ...
            <div class="panel">
                ...
                <div class="conexion-status">
                    ...
                    <span id="conexion-text">Conectado vía Web</span>
                </div>
...
def enviar_comando(accion):
    ...
    try:
        ...
        print(f"✅ Comando guardado en BD: {accion}")
...
def mover_motor():
    ...
    try:
        ...
        print(f"✅ Movimiento motor guardado: M{motor}, {pasos} pasos")
        return jsonify({
            "status": "success", 
...
def mover_posicion():
    ...
    try:
        ...
        print(f"✅ Posición guardada: {posiciones}")
        return jsonify({"status": "success", "mensaje": "Movimiento a posición ejecutado"})
        
    except Exception as e:
        print(f"❌ Error en movimiento posición: {e}")
        return jsonify({"status": "error", "error": str(e)}), 500
...
def guardar_posicion():
    ...
    try:
        ...
        print(f"✅ Posición '{nombre}' guardada")
...
def cargar_posicion(posicion_id):
    ...
    try:
        ...
        print(f"❌ Error cargando posición: {e}")
        return jsonify({"status": "error", "error": str(e)}), 500
...
def actualizar_estado():
    ...
    try:
        ...
        print("✅ Estado actualizado en BD desde ESP32")
...
if __name__ == '__main__':
    ...
    print(f"✅ Base de datos: {'Conectada' if get_db_connection() else 'Desconectada'}")
    print(f"📊 Dashboard: http://localhost:{port}")
    print(f"❤️  Salud: http://localhost:{port}/api/health")
